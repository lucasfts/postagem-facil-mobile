...
const RequiredSelect = ({ items, selectedValue, valueField, textField, label, placeholder, onChangeHandler, error }) => {
  return <FormControl isRequired isInvalid={error}>
    <FormControl.Label>{label}</FormControl.Label>
    <Select selectedValue={selectedValue} placeholder={placeholder} onValueChange={onChangeHandler} >
